...
public class ScopedOdysseyLogger extends OdysseyLogger {

  private final OdysseyLogger delegate;
  private final String scope;

  public ScopedOdysseyLogger(OdysseyLogger delegate, String scope) {
