...
/**
 * An internal, per-step increment produced by a Tier-2 solve, before it is flattened (with a running
 ...
 * @param cell the cell arrived at
...
record RawStep<T extends Enum<T>, I, D extends Domain>(
    Cell cell, D domain, double stepCost, T stepType, I instruction) {
}
