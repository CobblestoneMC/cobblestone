 ...
 * (Cobblestone's Tier-1 transition graph) can be searched by materializing only the frontier
 * actually reached. Edge costs may be {@link Double#POSITIVE_INFINITY} to mark an edge as
 * untraversable; such edges are skipped.
 *
