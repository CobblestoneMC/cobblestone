...
/**
 * Resolves OdysseyBetonQuest's per-compass navigation preferences from the plugin config: whether a
 * compass auto-navigates, and the {@link NavigatorSettings} (navigator id + trail particles/colors)
 * to guide it with. Each field falls back from a per-compass override ({@code
