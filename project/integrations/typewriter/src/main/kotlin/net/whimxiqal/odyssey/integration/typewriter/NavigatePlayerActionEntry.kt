...
package net.whimxiqal.odyssey.integration.typewriter
...
@Entry(
    "odyssey_navigate_player",
    "Guide the player to a location with Odyssey",
    Colors.GREEN,
    "mdi:map-marker-path",
)
/**
 * The `Navigate Player` action starts an Odyssey trip guiding the triggering player to a target
 * location, drawing Odyssey's live trail from the player to that point.
 *
