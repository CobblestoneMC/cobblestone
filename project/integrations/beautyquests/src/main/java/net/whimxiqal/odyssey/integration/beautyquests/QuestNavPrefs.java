...
/**
 * Resolves OdysseyBeautyQuests' per-quest navigation preferences from the plugin config: whether a
 ...
 * Quests are keyed by their numeric BeautyQuests id, passed here as a string.
 *
