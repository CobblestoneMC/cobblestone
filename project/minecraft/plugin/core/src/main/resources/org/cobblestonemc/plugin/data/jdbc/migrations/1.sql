...
CREATE TABLE cobblestone_location (
...
CREATE TABLE cobblestone_portal_transition (
...
CREATE TABLE cobblestone_end_return_portal (
  world VARCHAR(255) NOT NULL,
  min_x INTEGER NOT NULL,
  min_y INTEGER NOT NULL,
  min_z INTEGER NOT NULL,
...
CREATE TABLE cobblestone_end_gateway (
  world VARCHAR(255) NOT NULL,
  x INTEGER NOT NULL,
  y INTEGER NOT NULL,
  z INTEGER NOT NULL,
