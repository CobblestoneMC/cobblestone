...
/**
 * Odyssey's message palette. The prefix and primary accents use {@link #PRIMARY}; input parameters
 * substituted into a message are highlighted in {@link #SECONDARY}; the rest of a line takes its
 * {@link MessageCategory} base color ({@link #INFO}/{@link #SUCCESS}/{@link #ERROR}).
 */
public final class OdysseyColors {
