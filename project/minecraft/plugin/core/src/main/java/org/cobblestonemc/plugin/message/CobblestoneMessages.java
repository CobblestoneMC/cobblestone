...
/**
 * The catalog of Cobblestone's user-facing messages. Each constant names a bundle key and its
 ...
 */
public final class CobblestoneMessages {
  ...
  /** The {@code /cobblestone} usage hint. */
  public static final Message1 COBBLESTONE_USAGE = Message1.info("command.cobblestone.usage");

  /** Header line for the {@code /cobblestone} help menu. */
  public static final Message0 HELP_HEADER = Message0.info("command.cobblestone.help.header");
  ...
  /** Confirms a successful {@code /cobblestone reload}. */
  public static final Message0 RELOAD_SUCCESS =
      Message0.success("command.cobblestone.reload.success");
  ...
  public static final Message0 LOCATION_STORE_ERROR =
      Message0.error("command.cobblestone.location.store_error");
  ...
  public static final Message1 CANCEL_DONE = Message1.success("command.cobblestone.cancel.done");

  /** Confirms a single trip was cancelled by id ({@code {0}} = the id). */
  public static final Message1 CANCEL_TRIP = Message1.success("command.cobblestone.cancel.trip");

  /** Shown when no active trip has the given id ({@code {0}} = the id). */
  public static final Message1 CANCEL_NOT_FOUND =
      Message1.error("command.cobblestone.cancel.not_found");

  /** Shown when there is nothing to cancel. */
  public static final Message0 CANCEL_NOTHING = Message0.info("command.cobblestone.cancel.nothing");

  /** Header for the active-trips list ({@code {0}} = the count). */
  public static final Message1 TRIPS_HEADER = Message1.info("command.cobblestone.trips.header");

  /**
   * One entry in the active-trips list ({@code {0}} = id, {@code {1}} = destination, {@code {2}} =
   * remaining duration).
   */
  public static final Message3 TRIPS_ENTRY = Message3.info("command.cobblestone.trips.entry");
