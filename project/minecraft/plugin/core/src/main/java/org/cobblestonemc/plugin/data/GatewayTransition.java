 ...
 * entity, so Cobblestone caches the exit here (learned from a player's teleport) and updates it if
 * a later teleport lands somewhere different. Keyed by the gateway block ({@code world, x, y, z}).
 *
