...
/**
 * An H2-backed {@link DataStore}, stored in a single embedded file (H2 appends its own {@code
 * .mv.db} suffix). An alternative embedded backend to SQLite; the {@code h2} driver is downloaded
 * at runtime by the platform plugin's library loader.
 */
public final class H2DataStore extends AbstractJdbcDataStore {
   ...
   */
  public H2DataStore(Path file, CobblestoneLogger logger) {
