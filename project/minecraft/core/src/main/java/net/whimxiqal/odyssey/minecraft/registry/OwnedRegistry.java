...
/**
 * A thread-safe registry of values Odyssey collects from other plugins and its own extensions,
 ...
 * the Bukkit service manager used to do for us, now that Odyssey owns the collection).
 *
