...
/**
 * Adapts the plugin's {@link java.util.logging.Logger} to Cobblestone's {@link CobblestoneLogger}
 * seam, translating SLF4J-style {@code {}} placeholders into the interpolated message.
 *
 ...
 */
final class JulCobblestoneLogger extends CobblestoneLogger {

  private final Logger logger;
  private volatile LogLevel threshold = LogLevel.INFO;

  JulCobblestoneLogger(Logger logger) {
    this.logger = logger;
  }
