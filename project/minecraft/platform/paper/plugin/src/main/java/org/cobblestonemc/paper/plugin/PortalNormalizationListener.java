...
/**
 * Optional determinism for nether portal linking, so Cobblestone's block-granular routing is exact.
 ...
 *       entered — the determinism Cobblestone's single region&nbsp;&rarr;&nbsp;point link relies
 *       on.
