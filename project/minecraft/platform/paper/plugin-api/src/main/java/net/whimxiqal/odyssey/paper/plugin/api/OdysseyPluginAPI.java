 ...
 *   OdysseyPlugin.registrar().registerDestinations(this, new MyDestinationService());
 *   OdysseyPlugin.tripService().navigate(player, location, settings, "my label");
 * }
 * }</pre>
 *
 * <p>Search modifiers and the raw navigation service live one layer down, on {@code OdysseyCore}
 * (in the core API). Both entry points are backed by Odyssey-provided Bukkit services.
 */
public final class OdysseyPluginAPI {
  ...
  public static IntegrationRegistrar registrar() {
    return Objects.requireNonNull(
            ...
            "Odyssey integration registrar is not registered")
        .getProvider();
  }
  ...
  public static TripService tripService() {
    return Objects.requireNonNull(
            ...
            "Odyssey trip service is not registered")
        .getProvider();
  }
}
