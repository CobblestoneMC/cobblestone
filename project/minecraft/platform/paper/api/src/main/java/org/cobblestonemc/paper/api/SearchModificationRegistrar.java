 ...
 * via {@link CobblestoneCoreApi#registrar()}) and owns the resulting collection — this replaces
 * registering a service per provider into Bukkit for Cobblestone to enumerate.
 *
