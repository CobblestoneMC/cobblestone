 ...
 */
public interface Transition extends PlatformTransition<WorldRegion<World, Vector3i>, Location> {
   ...
   * @return the transition
   */
  static Transition command(Player player, Location destination, double cost, String command) {
    return of(
