...
/**
 * The single hook by which a plugin influences Cobblestone's searches. Register one as a Bukkit
 * service and Cobblestone folds it into every search:
 *
 * <pre>{@code
 * getServer().getServicesManager().register(
 *     CobblestoneSearchModifier.class, myModifier, myPlugin, ServicePriority.Normal);
 * }</pre>
 *
