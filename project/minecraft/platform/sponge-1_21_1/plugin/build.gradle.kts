// sponge-1_21_1-plugin — the shippable SpongeAPI plugin for 1.21.1 (shaded uberjar). Not published.
//
...
// 1.21.1, and its bytecode runs unchanged on the newer JVM this jar targets.
java {
    toolchain {
...
// for this module — an admin downloads `Cobblestone-Sponge-1.21.1-<version>.jar` and can tell at a
