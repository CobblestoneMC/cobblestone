...
package org.cobblestonemc.sponge.api;
...
/**
 * The single hook by which a plugin influences Cobblestone's searches. Register one with
 * Cobblestone's {@link SearchModificationRegistrar} and Cobblestone folds it into every search.
 *
