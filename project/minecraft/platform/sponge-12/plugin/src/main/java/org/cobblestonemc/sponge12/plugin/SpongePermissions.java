...
/**
 * Describes Cobblestone's permission nodes to the server's permission service — Sponge's
 * counterpart to Paper's {@code permissions:} block. Without a description a node has no default,
 * so a permission plugin would deny it to everyone; the player-facing nodes must default to allow.
 */
