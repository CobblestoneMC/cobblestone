...
public interface DestinationService {
   ...
   * registering plugin's id, so two plugins offering a {@code warp} level stay distinguishable.
   * Build the levels below that — {@code DestinationTree.builder().subtree("warp", …)} — not a
