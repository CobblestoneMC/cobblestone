...
/**
 * Static conversions between Sponge's {@link ServerLocation} and Cobblestone's internal {@link
 * Cell}/ {@link Position}, so the Sponge façade can speak native types on its surface while the
 * core speaks its own.
 */
