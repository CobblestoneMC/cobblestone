 ...
 * steps inside to a named {@link Destination}. Because it references the destination by name,
 * editing that destination moves every portal linked to it. Surfaced to navigation as a {@code
 * PORTAL} transition (walked into, not commanded), which exercises Odyssey's region-origin logic.
 *
