 ...
 * warps and auto-teleport portal pads — and registers a {@link PaperTransitionProvider} so Odyssey
...
public final class OdysseyWarpsPlugin extends JavaPlugin {
  ...
  public void onEnable() {
    ...
    // The single hook into navigation: register a transition provider as a Bukkit service.
    getServer().getServicesManager().register(
        PaperTransitionProvider.class, new WarpTransitionProvider(store), this, ServicePriority.Normal);
